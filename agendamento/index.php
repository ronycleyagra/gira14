...
$expositores = Control::getExpositores();
?>
<br>
            <table width="100%">
               <tr>
                    <td width="50%" align="left" class="trTopico">
                       Agendamento da rodada
                    </td>
               </tr>
            </table>
            ﻿﻿﻿<form action="agendar.php" method="post" name="formAgend">
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td align="left" style="background-color: #DEDEDE;" >EXPOSITOR:</td>
                        <td align="left">
                            <select name="ide" onChange="javascript: dadosComprador(this);" class="selectComprador">
                                
                                <?php
                            
                            
                            for($i=0; $i<count($expositores); $i++){
                                $expositor = $expositores[$i];
                                    ?>
                    ...
                    onClick="javascript:document.formAgend.submit();">Agendar</button>
                        </td>
                    </tr>
                </table>
